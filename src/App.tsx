...
function App() {
  ...
  const [isSpeedEnabled, setIsSpeedEnabled] = useState(initialSettings.isSpeedEnabled ?? false)
  ...
  const [lowPassQ, setLowPassQ] = useState(initialSettings.lowPassQ ?? 0.4)
  ...
  const [vizMode, setVizMode] = useState<VizMode>(initialSettings.vizMode ?? 'milkdrop')
  ...
  const [milkdropCellSize, setMilkdropCellSize] = useState(initialSettings.milkdropCellSize ?? 6)
  const [milkdropUseAscii, setMilkdropUseAscii] = useState(initialSettings.milkdropUseAscii ?? true)
  const [milkdropAutoRamp, setMilkdropAutoRamp] = useState(initialSettings.milkdropAutoRamp ?? false)
  const [milkdropThemeId, setMilkdropThemeId] = useState(initialSettings.milkdropThemeId ?? 'violet')
